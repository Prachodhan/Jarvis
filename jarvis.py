...
@eel.expose
def trail():
    eel.addText("Hello this is Jarvis , the voice assisstant")
    talk("Hello this is Jarvis , the voice assisstant")
    while True:
        text = get_audio()
        text = text
        ...
        if "time" in text:
            ...
            speak = """Hello, I am Jarvis,The Voice assisstant. 
            I was created by Karthikeya and Buvan"""
            ...
            if "youtube" in text.lower():
                ...
                webbrowser.open("https://github.com/sai-krishna-ghanta/Jarvis-Voiceassisstant")  
            ...
            eel.addText("Terminating Jarvis")
            talk("Terminating Jarvis")
            speak = " "
            break
